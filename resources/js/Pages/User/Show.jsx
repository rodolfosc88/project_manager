...
export default function Show({auth, user, tasks, queryParams}) {
    return (
        <AuthenticatedLayout
            auth={auth}
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">{`Usuário "${user.name}"`}</h2>}
        >
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        ...
                        <div className="p-6 text-gray-900 dark:text-gray-100">                            
                            <div className="grid gap-1 grid-cols-2 mt-2">
                                <div>
                                    <div>
                                        <label className="font-bold text-lg">ID Usuário</label>
                                        <p className="mt-1">{user.id}</p>
                                    </div>
                                    <div className="mt-4">
                                        <label className="font-bold text-lg">Nome do Usuário</label>
                                        <p className="mt-1">{user.name}</p>
                                    </div>
                                    <div className="mt-4">
                                        <label className="font-bold text-lg">Status do Usuário</label>
                                        <p className="mt-1">
                                        <span className={
                            ...
                            <div className="mt-4">
                                <label className="font-bold text-lg">Descrição do Usuário</label>
